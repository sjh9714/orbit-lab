...
export default {
  ...
  use: { ...base.use, baseURL: 'http://127.0.0.1:5182', browserName: 'webkit', channel: undefined },
  webServer: { ...base.webServer, command: 'npm run dev -- --port 5182 --strictPort', url: 'http://127.0.0.1:5182' },
